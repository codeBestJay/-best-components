...
import { GeneralNormalFormWrapper } from "../../index";
import { withRouter } from 'storybook-addon-react-router-v6';
import React from "react";
import { Form, Input, TableProps, Button } from "antd";

const meta = {
  title: '常用详情布局/GeneralNormalFormWrapper',
  component: GeneralNormalFormWrapper,
  decorators: [withRouter],
  tags: ["autodocs"],
  argTypes: {
    centerFooter: {
      description: "boolean类型， true：使用自带的确定/取消按钮页脚；false: 页脚为空"
    }
  }

} satisfies Meta<typeof GeneralNormalFormWrapper>

export default meta;
type Story = StoryObj<typeof meta>;


export const normalWrapperExample: Story = {
  args: {
    title: '常用详情页面标题',
    centerFooter: true,
